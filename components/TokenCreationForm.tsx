  ...
  const createToken = useCallback(async () => {
    try {
      ...
      const mintIx = createMintToInstruction(
        ...
        publicKey,  // Owner of the minted tokens
        publicKey,  // The authority for minting new tokens
        [],
        supply
      );
